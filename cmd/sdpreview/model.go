...
func ModelNew(container *mdb.Container, sceneObject scd.SceneObject) *Model {
	model := &Model{
		Meshes:   []rl.Mesh{},
		Material: rl.LoadMaterialDefault(),
		Position: rl.NewVector3(sceneObject.Position.X, sceneObject.Position.Y, sceneObject.Position.Z),
	}
